...
brepjs itself is [Apache-2.0](./LICENSE). The kernel you register carries its own license, and for shipped products the kernel's license is the one that matters:

| Package | License | What it means for your product |
| ------- | ------- | ------------------------------ |
| `brepjs` (this package) | Apache-2.0 | Use freely, open or proprietary |
| `occt-wasm` kernel | LGPL-2.1 | Proprietary use permitted under the LGPL's terms |
