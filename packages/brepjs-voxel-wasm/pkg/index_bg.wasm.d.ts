...
export const __wbg_scalarfield_free: (a: number, b: number) => void;
...
export const scalarfield_axial_ramp: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
export const scalarfield_clamp: (a: number, b: number, c: number) => [number, number, number];
export const scalarfield_constant: (a: number) => number;
export const scalarfield_from_sdf: (a: number, b: number, c: number) => number;
export const scalarfield_radial_ramp: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number];
...
export const sdf_lattice: (a: number, b: number, c: number) => [number, number, number];
export const sdf_offset: (a: number, b: number) => number;
export const sdf_offset_field: (a: number, b: number) => number;
...
export const sdf_round_field: (a: number, b: number) => number;
...
export const sdf_shell_field: (a: number, b: number) => number;
...
export const sdf_smooth_union_field: (a: number, b: number, c: number) => number;
export const sdf_sphere: (a: number) => number;
export const sdf_strut_lattice: (a: number, b: number) => [number, number, number];
