...
export declare class IFSelect_WorkSession extends Standard_Transient {
  ...
  ItemIdents(type: Handle_Standard_Type): any;
  ItemNames(type: Handle_Standard_Type): any;
  ...
  SetParams(params: Standard_Integer, uselist: Standard_Integer): void;
...
export declare class MeshData {
  getVerticesPtr(): Standard_Integer;
  getNormalsPtr(): Standard_Integer;
  getTrianglesPtr(): Standard_Integer;
  getFaceGroupsPtr(): Standard_Integer;
  getUvsPtr(): Standard_Integer;
  getVerticesSize(): Standard_Integer;
  getNormalsSize(): Standard_Integer;
  getTrianglesSize(): Standard_Integer;
  getFaceGroupsSize(): Standard_Integer;
  getUvsSize(): Standard_Integer;
  delete(): void;
}

  export declare class MeshData_1 extends MeshData {
    constructor();
  }

  export declare class MeshData_2 extends MeshData {
    constructor(other: MeshData);
  }

export declare class MeshExtractor {
  constructor();
  static extract(shape: TopoDS_Shape, tolerance: Standard_Real, angularTolerance: Standard_Real, skipNormals: Standard_Boolean, includeUVs: Standard_Boolean): MeshData;
  delete(): void;
}

export declare class BooleanBatch {
  constructor();
  addShape(s: TopoDS_Shape): void;
  clear(): void;
  count(): Standard_Integer;
  fuseAll(glueMode: Standard_Integer, simplify: Standard_Boolean, fuzzyValue: Standard_Real): TopoDS_Shape;
  cutAll(base: TopoDS_Shape, glueMode: Standard_Integer, simplify: Standard_Boolean, fuzzyValue: Standard_Real): TopoDS_Shape;
  delete(): void;
}
...
export declare class EvolutionData {
  getModifiedPtr(): Standard_Integer;
  getGeneratedPtr(): Standard_Integer;
  getDeletedPtr(): Standard_Integer;
  getModifiedSize(): Standard_Integer;
  getGeneratedSize(): Standard_Integer;
  getDeletedSize(): Standard_Integer;
  delete(): void;
}

  export declare class EvolutionData_1 extends EvolutionData {
    constructor();
  }

  export declare class EvolutionData_2 extends EvolutionData {
    constructor(other: EvolutionData);
  }

export declare class EvolutionExtractor {
  constructor();
  static extract(builder: BRepBuilderAPI_MakeShape, inputShape: TopoDS_Shape, hashUpperBound: Standard_Integer): EvolutionData;
  delete(): void;
}
...
export declare class MeasurementData {
  getDataPtr(): Standard_Integer;
  getDataSize(): Standard_Integer;
  delete(): void;
}

  export declare class MeasurementData_1 extends MeasurementData {
    constructor();
  }

  export declare class MeasurementData_2 extends MeasurementData {
    constructor(other: MeasurementData);
  }

export declare class MeasurementExtractor {
  constructor();
  static extract(shape: TopoDS_Shape, includeLinear: Standard_Boolean): MeasurementData;
  delete(): void;
}

export declare class TransformBatchResult {
  getShapesCount(): Standard_Integer;
  getShape(index: Standard_Integer): TopoDS_Shape;
  delete(): void;
}

  export declare class TransformBatchResult_1 extends TransformBatchResult {
    constructor();
  }

  export declare class TransformBatchResult_2 extends TransformBatchResult {
    constructor(other: TransformBatchResult);
  }

export declare class TransformBatch {
  constructor();
  addTranslate(shape: TopoDS_Shape, x: Standard_Real, y: Standard_Real, z: Standard_Real): void;
  addRotate(shape: TopoDS_Shape, angle: Standard_Real, axX: Standard_Real, axY: Standard_Real, axZ: Standard_Real, cX: Standard_Real, cY: Standard_Real, cZ: Standard_Real): void;
  addScale(shape: TopoDS_Shape, cX: Standard_Real, cY: Standard_Real, cZ: Standard_Real, factor: Standard_Real): void;
  addMirror(shape: TopoDS_Shape, oX: Standard_Real, oY: Standard_Real, oZ: Standard_Real, nX: Standard_Real, nY: Standard_Real, nZ: Standard_Real): void;
  clear(): void;
  count(): Standard_Integer;
  execute(): TransformBatchResult;
  delete(): void;
}

export declare class ShapeBatchResult {
  getShapesCount(): Standard_Integer;
  getShape(index: Standard_Integer): TopoDS_Shape;
  delete(): void;
}

  export declare class ShapeBatchResult_1 extends ShapeBatchResult {
    constructor();
  }

  export declare class ShapeBatchResult_2 extends ShapeBatchResult {
    constructor(other: ShapeBatchResult);
  }

export declare class LoftBatch {
  constructor();
  beginLoft(solid: Standard_Boolean, ruled: Standard_Boolean, tolerance: Standard_Real): Standard_Integer;
  addWire(entryIndex: Standard_Integer, wire: TopoDS_Shape): void;
  setStartVertex(entryIndex: Standard_Integer, vertex: TopoDS_Shape): void;
  setEndVertex(entryIndex: Standard_Integer, vertex: TopoDS_Shape): void;
  clear(): void;
  count(): Standard_Integer;
  execute(): ShapeBatchResult;
  delete(): void;
}

export declare class ExtrudeBatch {
  constructor();
  addExtrude(face: TopoDS_Shape, dx: Standard_Real, dy: Standard_Real, dz: Standard_Real): void;
  clear(): void;
  count(): Standard_Integer;
  execute(): ShapeBatchResult;
  delete(): void;
...
export declare class ShellBatch {
  constructor();
  beginShell(shape: TopoDS_Shape, thickness: Standard_Real, tolerance: Standard_Real): Standard_Integer;
  addFaceToRemove(entryIndex: Standard_Integer, face: TopoDS_Shape): void;
  clear(): void;
  count(): Standard_Integer;
  execute(): ShapeBatchResult;
  delete(): void;
...
export declare class FilletBatch {
  constructor();
  beginFillet(shape: TopoDS_Shape): Standard_Integer;
  addEdge(entryIndex: Standard_Integer, shape: TopoDS_Shape, radius: Standard_Real): void;
  addEdgeVariable(entryIndex: Standard_Integer, shape: TopoDS_Shape, r1: Standard_Real, r2: Standard_Real): void;
  clear(): void;
  count(): Standard_Integer;
  execute(): ShapeBatchResult;
  delete(): void;
...
export type OpenCascadeInstance = {FS: typeof FS} & {
  ...
  EvolutionData_1: typeof EvolutionData_1;
  EvolutionData_2: typeof EvolutionData_2;
  EvolutionExtractor: typeof EvolutionExtractor;
  ...
  MeasurementData: typeof MeasurementData;
  MeasurementData_1: typeof MeasurementData_1;
  MeasurementData_2: typeof MeasurementData_2;
  MeasurementExtractor: typeof MeasurementExtractor;
  TransformBatchResult: typeof TransformBatchResult;
  TransformBatchResult_1: typeof TransformBatchResult_1;
  TransformBatchResult_2: typeof TransformBatchResult_2;
  TransformBatch: typeof TransformBatch;
  ShapeBatchResult: typeof ShapeBatchResult;
  ShapeBatchResult_1: typeof ShapeBatchResult_1;
  ShapeBatchResult_2: typeof ShapeBatchResult_2;
  LoftBatch: typeof LoftBatch;
  ExtrudeBatch: typeof ExtrudeBatch;
  ShellBatch: typeof ShellBatch;
  FilletBatch: typeof FilletBatch;
