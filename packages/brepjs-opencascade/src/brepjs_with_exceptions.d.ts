...
export declare class MeshExtractor {
  constructor();
  static extract(shape: TopoDS_Shape, tolerance: Standard_Real, angularTolerance: Standard_Real, skipNormals: Standard_Boolean): MeshData;
  delete(): void;
}
...
export declare class BooleanBatch {
  ...
  fuseAll(glueMode: Standard_Integer, simplify: Standard_Boolean): TopoDS_Shape;
  cutAll(base: TopoDS_Shape, glueMode: Standard_Integer, simplify: Standard_Boolean): TopoDS_Shape;
  delete(): void;
}
