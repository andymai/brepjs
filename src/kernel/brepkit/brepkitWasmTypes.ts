 ...
 * Synced against `brepkit-wasm@2.129.13`.
 *
...
export interface BrepkitKernel {
  ...
  /** @unwired */
  fuseAll(solidHandles: Uint32Array | number[]): number;
  ...
  guidedSweep(
    face: number,
    spineDegree: number,
    spineKnots: Float64Array | number[],
    spineControlPoints: Float64Array | number[],
    spineWeights: Float64Array | number[],
    auxDegree: number,
    auxKnots: Float64Array | number[],
    auxControlPoints: Float64Array | number[],
    auxWeights: Float64Array | number[]
  ): number;
  ...
  /** @future Not in brepkit-wasm 2.129.13. Referenced with feature detection in adapter. */
  chamferAsymmetric?(
    solid: number,
    edgeHandles: Uint32Array | number[],
    d1: number,
