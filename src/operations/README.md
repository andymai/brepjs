...
| `extrudeUtils.ts`  | Shared utilities: `SweepConfig` interface (base sweep config), `ExtrusionProfile` interface, `buildLawFromProfile()` for creating OCCT Law objects. OO API's `GenericSweepConfig` extends `SweepConfig` with Wire\|Edge typing                                                                                                                                                                                                                                                                           |
